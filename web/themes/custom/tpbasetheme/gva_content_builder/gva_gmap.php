   ...
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       <?php ob_start() ?>
         ...
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'tp_basetheme')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'tp_basetheme')) ?>/vendor/jquery.ui.map.min.js"></script>
