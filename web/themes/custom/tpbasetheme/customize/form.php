<div id="gavias_customize_form" class="gavias_customize_form">
   ...
   <div class="form-group action">
      ...
      <input type="hidden" id="gva_theme_name" name="theme_name" value="tp_basetheme" />
   </div>   
         ...
         <div class="card">
            ...
            <div id="customize-body" class="collapse" data-parent="#customize-accordion">
               <div class="card-body">
                  ...
                  <div class="form-wrapper">
                  <div class="desc" style="line-height: 16px;"><b>You can upload image for /themes/tp_basetheme/images/patterns</b></div>
                     <div class="form-group">
